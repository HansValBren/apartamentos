                ...
                <PopoverContent className="p-0">
                  <Card className="shadow-none border-0">
                    <CardHeader className="border-b">
                      ...
                      <CardDescription>Tienes {cantidadPreguntasSinRespuesta} {cantidadPreguntasSinRespuesta === 1 ? 'consulta sin responder' : 'consultas sin responder'}.
                      </CardDescription>
                     <CardDescription className="underline decoration-blue-400 text-blue-400">
                      <Link href="/contacto">Ver todas las consultas</Link>
                     </CardDescription>
                    </CardHeader>
                    <CardContent className="p-6">
                      {preguntasSinRespuesta.map((pregunta) => (
                        <div key={pregunta.pregunta_id} className="mb-4 grid grid-cols-[25px_1fr] items-start pb-4 last:mb-0 last:pb-0">
                        ...
                        <div className="grid gap-1">
                          ...
                          <p className="text-sm text-muted-foreground">Tel: {pregunta.pregunta_telefono.slice(0, 4)} {pregunta.pregunta_telefono.slice(4, 8)} </p>
                          <p className="text-sm text-muted-foreground">{timeSince(pregunta.pregunta_created_at.toString())}</p>
                        </div>
                      </div>
                      ))}
                    </CardContent>
